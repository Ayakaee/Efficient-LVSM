...
# 1. 设置你的路径
gso_root_dir = "/inspire/hdd/global_user/chenxinyan-240108120066/yihang/LVSM/dataset/abo/3dmodels/original/1"
output_render_dir = "/inspire/hdd/global_user/chenxinyan-240108120066/yihang/LVSM/dataset/abo_render"
...
object_folders = os.listdir(gso_root_dir)
# 2. 遍历每个对象并进行渲染
for folder_name in tqdm(object_folders, desc="Rendering GSO objects"):
    obj_path = os.path.join(gso_root_dir, folder_name)
